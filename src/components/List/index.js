        ...
        return (
            <div className="list-container">
                ...
                <div className="list-settings">
                    <input ref={this.inputRef} onChange={() => this.filterList(this.state.show)} placeholder="Search..." data-intro='Search item type here!'/>
                    <div className="radio-buttons-container" data-intro='This is filter item section!'>
                        <label
                    ...
                    <ul className="list" data-intro='Checklist item list and Edit/Delete or Drag Section!'>
                ...
                <Link to="/add" className="nav-button" data-intro='Add item todoList!'>
